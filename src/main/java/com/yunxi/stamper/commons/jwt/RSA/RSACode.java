...
public class RSACode {
	...
	public static byte[] decryptByPrivateKey(String data, String key) throws Exception {
		if (StringUtils.isNoneBlank(data, key)) {
...
//
//		byte[] decodedData = RSACode.decryptByPrivateKey(Base64Util.decode("mIENuMEvbTkceKAzoqDLx8qiuZ12wZ5eRhZMKf2dfL+ZJkxJHnBXxNZiMpbIFHjIJSoP7sBxknR8PEPFAVgNoL2HqlEmOGFzpXugWK37fDpoKSOFpT0AKJyY4/j87F52YZlIjsJgk74+KDyrPKxagzEZejb8bAI4Ln/54UaVhd0="), privateKey);
